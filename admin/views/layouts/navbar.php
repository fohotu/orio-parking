    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link" data-toggle="dropdown" href="#">
                ...
                <span class="badge badge-warning navbar-badge">Change User</span>
            </a>
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                <?php 
                    echo Yii::$app->user->id;
                ?>
                <form action="<?php echo \yii\helpers\Url::to(['site/change-user'])?>" method="POST">
                    <button name="role" value="a" type="submit">Admin</button>
                    <button name="role" value="m" type="submit">Moderator</button>
                    <button name="role" value="t" type="submit">Tenant</button>
                </form>
            </div>
        </li>
        <li class="nav-item">
